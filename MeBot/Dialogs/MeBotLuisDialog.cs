...
{
    [LuisModel("4efeba4c-f330-47d1-a652-355068a3c362", "d8f17e3c1c9a40a3b8d201d3b5cde110")]
    [Serializable]
    public class MeBotLuisDialog : LuisDialog<object>
    {
        ...
        {
            await context.PostAsync(@"Sahithi is a Student who is currently pursuing IV B.Tech at Shri Vishnu Engineering College for Women 
                at Bhimavaram. He started his professional career in 2013 after completing his graduation as Bachelor in Computer Science.");
            await context.PostAsync(@"She is a technology enthusiast and loves to dig in emerging technologies. 
                Most of her working hours are spent on creating architecture, evaluating upcoming products and developing frameworks.");
            context.Wait(MessageReceived);
        }
